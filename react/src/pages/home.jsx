...
<div className=" grid lg:grid-cols-2  grid-cols-1  w-4/5   md:h-1/2 h-full      mx-auto   mt-10">
    <div className="col-span-1 mb-4 ">
      <a href="#" className="py-8 mx-auto flex flex-col items-center bg-white   rounded-lg  md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
    ...
    <div className="col-span-1 mb-4">
      <a href="#" className="py-8 mx-auto flex flex-col items-center bg-white hover:bg-gray-100   rounded-lg  md:flex-row md:max-w-xl  dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
